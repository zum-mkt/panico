...
insert into public.plans (title, description, price, benefits, is_featured, position) values
...
insert into public.testimonials (author_name, content, rating, position) values
...
insert into public.faq (question, answer, context, position) values
...
insert into public.partners (name, position) values
  ('Parceiro 1', 1),
  ('Parceiro 2', 2),
  ('Parceiro 3', 3)
on conflict do nothing;
